...
ACTIVITY_FRAME_SECONDS = 1 / 30
ACTIVITY_WAVE_TRAVEL_FRAMES = 21
ACTIVITY_WAVE_PAUSE_FRAMES = 15
ACTIVITY_WAVE_WIDTH = 12
ACTIVITY_WAVE_SHADE_COUNT = 13
...
FILE_REFERENCE_LIMIT = 10
FILE_REFERENCE_INDEX_REFRESH_SECONDS = 30.0
FILE_REFERENCE_CACHE_SECONDS = 2.0
FILE_REFERENCE_FIRST_LEVEL_LIMIT = 200
PROMPT_PASTE_COLLAPSE_THRESHOLD = 100
